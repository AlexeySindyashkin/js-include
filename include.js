...
Array.prototype.have = (Array.prototype.indexOf==undefined) ?
	...
	function (val) {var i=this.length;while(i--)if(this[i]===val){delete i;return true;}delete i;return false}
 ...
 *	@return Array index
*/
if(Array.prototype.indexOf==undefined)Array.prototype.indexOf=function(val){var i=this.length;while(i--)if(this[i]===val){return i;}delete i;return false}
})(Array);
